...
- [Navbar structure](mem://features/navbar) — Dropdowns: Competitivo (Seasons, Torneios), Recursos (Regras, Biblioteca, Materiais), Nossas Redes. Partidas link direto com Calendar icon. Mobile: accordion.
