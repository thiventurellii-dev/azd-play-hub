...
import { Home, Calendar, Gamepad2, Users, MoreHorizontal, Trophy, BarChart3, Lightbulb, Shield, LogOut, FileText, Info, Download, MessagesSquare } from "lucide-react";
        ...
        <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
          ...
          <DrawerContent>
            ...
            <div className="p-4 pb-8 space-y-1">
              ...
              <Link to="/comunidades" onClick={() => setDrawerOpen(false)}>
                <Button variant="ghost" className="w-full justify-start gap-3 h-12 text-base">
                  <MessagesSquare className="h-5 w-5" /> Comunidades
                </Button>
              </Link>
