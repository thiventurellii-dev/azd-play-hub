import { Users, MessageCircle, AtSign } from "lucide-react";
...
export const LandingCommunitiesSection = () => (
  <SplitSection
    ...
    body="A Amizade envolve todas as outras comunidades. Crie seu próprio grupo na plataforma — gerencie membros, organize seus rankings, agende partidas e mantenha discussões num espaço só seu."
    features={[
