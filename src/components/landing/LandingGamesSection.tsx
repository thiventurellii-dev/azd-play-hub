    ...
    <div className="container">
      <div className="text-center mb-14 max-w-2xl mx-auto">
        ...
        <motion.p {...fadeUp(0.2)} className="mt-5 text-base md:text-lg text-muted-foreground leading-relaxed">
          Do dedutivo social ao euro pesado, a comunidade AzD abraça uma variedade de títulos. Cada jogo tem seu próprio espaço com regras, scripts e histórico de partidas.
        </motion.p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {games.map((g, i) => (
          <motion.div
            key={g.name}
            {...fadeUp(0.1 + i * 0.1)}
            className="bg-card border border-border rounded-2xl overflow-hidden hover:border-gold/40 hover:-translate-y-1 transition-all duration-300 hover:shadow-[0_16px_48px_-12px_hsl(var(--gold)/0.15)]"
          >
            <div className="aspect-video bg-surface-raised flex items-center justify-center text-6xl">
              {g.emoji}
            </div>
            <div className="p-5">
