...
export const citiesByState: Record<string, string[]> = {
  ...
  SP: ['Americana', 'Amparo', 'Araçatuba', 'Araraquara', 'Atibaia', 'Barueri', 'Bauru', 'Botucatu', 'Bragança Paulista', 'Campinas', 'Carapicuíba', 'Catanduva', 'Cotia', 'Diadema', 'Embu das Artes', 'Ferraz de Vasconcelos', 'Franca', 'Guarujá', 'Guarulhos', 'Hortolândia', 'Indaiatuba', 'Itapetininga', 'Itaquaquecetuba', 'Itatiba', 'Itu', 'Jacareí', 'Jundiaí', 'Limeira', 'Louveira', 'Marília', 'Mauá', 'Mogi das Cruzes', 'Mogi Guaçu', 'Mogi Mirim', 'Osasco', 'Paulínia', 'Piracicaba', 'Praia Grande', 'Presidente Prudente', 'Ribeirão Preto', 'Rio Claro', 'Salto', 'Santa Bárbara d\'Oeste', 'Santo André', 'Santos', 'São Bernardo do Campo', 'São Carlos', 'São José do Rio Preto', 'São José dos Campos', 'São Paulo', 'São Vicente', 'Sorocaba', 'Sumaré', 'Suzano', 'Taboão da Serra', 'Taubaté', 'Valinhos', 'Vinhedo', 'Votorantim'],
