...
const MatchRooms = () => {
  ...
  useEffect(() => {
    ...
    Promise.resolve(
      supabase
        .from("match_rooms")
        .select(
          "id, title, description, scheduled_at, max_players, status, created_by, season_id, blood_script_id, room_type, campaign_id, session_number, session_recap, session_title, duration_minutes, game:games(id, name, image_url)",
        )
        .eq("id", roomParam)
        .maybeSingle(),
    )
  ...
  const fetchRooms = async () => {
    ...
    const { data } = await supabase
      .from("match_rooms")
      .select(
        "id, title, description, scheduled_at, max_players, status, created_by, season_id, blood_script_id, room_type, campaign_id, session_number, session_recap, session_title, duration_minutes, result_id, result_type, game:games(id, name, image_url), match_room_tag_links(room_tags(name))",
      )
